...
public class Coral_intake_shoot extends SubsystemBase {
    ...
    final DigitalInput photoSensor = new DigitalInput(1); // 光電感測器
    final TalonFX CoralIntakeMotor = new TalonFX(10);
    ...
    // public Command intake_cmd() {
    //     return this.runOnce(() -> intake());
    // }
    // public Command shooter_cmd() {
    //     return this.runOnce(() -> shooter());
    // }
    
    
    // public void intake(){
    //      photo = true;
    //      CoralIntakeMotor.set(VictorSPXControlMode.PercentOutput, 0.02 * (180 - getdis()));
    //      left_handSpx.set(VictorSPXControlMode.PercentOutput, -0.02 * (180 - getdis()));
    //     if (photoSensor.get() == true && photo == true) {
    //         photo = true;
    //         leftintake.set(VictorSPXControlMode.PercentOutput, 0.4);
    //         rightintake.set(VictorSPXControlMode.PercentOutput, -0.4);
    ...
    //         rightintake.set(VictorSPXControlMode.PercentOutput, 0.1);
    ...
    // public void shooter() {
    //     right_handSpx.set(VictorSPXControlMode.PercentOutput, 0.02 * (142 - getdis()));
    //     left_handSpx.set(VictorSPXControlMode.PercentOutput, -0.02 * (142 - getdis()));
...
//         if (photoSensor.get() == true && photo == true) {
//             photo = true;
//             leftintake.set(VictorSPXControlMode.PercentOutput, 0.6);
//             rightintake.set(VictorSPXControlMode.PercentOutput, -0.6);
//             if (controller2.getRawButton(8)) {
//                 stopevery();
//             }
//         }
...
//         while (photoSensor.get() == false) {
//             photo = false;
//             leftintake.set(VictorSPXControlMode.PercentOutput, -0.2);
//             rightintake.set(VictorSPXControlMode.PercentOutput, 0.2);
//             while (photoSensor.get() == true && photo == false) {
//                 stopevery();
//             photo = true;
//             }
...
//     if (controller2.getRawButton(8)) {
//         SmartDashboard.putNumber("leftlift", leftlift.getSelectedSensorVelocity());
//         SmartDashboard.putNumber("rightlift", rightlift.getSelectedSensorVelocity());
//         leftlift.set(ControlMode.PercentOutput, 0.9);
//     } else {
//         leftlift.set(ControlMode.PercentOutput, 0);

//     }

//     if (controller2.getRawButton(10)) {
//         rightlift.set(ControlMode.PercentOutput, 1);
//     } else {
